...
class AlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album" do
    assert_difference('Album.count') do
      post albums_url, params: { album: { expiry_date: @album.expiry_date, name: @album.name } }
    end
  ...
  test "should update album" do
    patch album_url(@album), params: { album: { expiry_date: @album.expiry_date, name: @album.name } }
